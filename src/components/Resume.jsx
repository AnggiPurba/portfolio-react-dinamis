...
// 1. Import komponen Parallax dari library
...
{/* 2. Struktur diubah: .resume-row dan .resume-cols dihapus */}
  {/* Setiap bagian kini dibungkus <Parallax> secara terpisah */}

  {/* --- Professional Experience Section --- */}
  <Parallax speed={-5}> {/* Efek: Bergerak ke atas lebih lambat */}
  ...
  {/* --- Education Section --- */}
  <Parallax speed={5}> {/* Efek: Bergerak ke bawah saat scroll ke atas */}
     <div className="resume-section-wrapper">
  ...
  {/* --- Summary Section --- */}
  <Parallax speed={-2}> {/* Efek: Bergerak ke atas sangat lambat */}
    <div className="resume-section-wrapper">
